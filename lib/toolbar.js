...
(function () {
  ...
  var toolbar = function () {
    ...
    try {
this.containerEl.append(`<div class="toolbar" id="toolbar"><div class="main-buttons"></div><span class="centered-text">LAX.INK</span><div class="extended-buttons"></div></div>`);
